...
import { TecnicoResponse, Search } from '../interfaces/tecnicos.interface';

@Injectable({
  providedIn: 'root'
})
export class TecnicoValidatorService implements AsyncValidator {
