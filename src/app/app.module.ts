...
import { InterceptorService } from './comun/interceptors/interceptor.service';

registerLocaleData(localeEs, 'es-CL', registerLocaleData);
...
@NgModule({
    ...
    providers: [
        ...
        { provide: MAT_DATE_LOCALE, useValue: 'es-CL' }, { provide: LOCALE_ID, useValue: 'es-CL' },
