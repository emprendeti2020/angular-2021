...
export class DeptoComponent implements OnInit, AfterViewInit {
    ...
    openDialog(action: string, obj: any): void {
        obj.action = action;
        const dialogRef = this.dialog.open(DeptoDialogContent, {
            data: obj
        });
...
export class DeptoDialogContent {
    action: string;
    // tslint:disable-next-line - Disables all
    local_data: any;
    selectedImage: any = '';
    ...
    constructor(
        ...
        public datePipe: DatePipe,
        public dialogRef: MatDialogRef<DeptoDialogContent>,
